...
public class TestEnroqueCorto extends TestCase{
	...
	public void setUp(){
		tablero = new Tablero();
		jugador1 = new Jugador(new Rey(tablero.getCasillero(Tablero.Fila.UNO, Tablero.Columna.D)));
		jugador2 = new Jugador(new Rey(tablero.getCasillero(Tablero.Fila.OCHO, Tablero.Columna.D)));
		partida = new Partida(jugador1, jugador2, tablero);
	}
	
	public void testEnroqueCortoPositivo(){

		Torre torreJugador1 = ((Torre)(jugador1.getPieza(Tablero.Fila.UNO, Tablero.Columna.H)));
		Rey reyJugador1 = jugador1.getRey();
		
		Casillero casilleroTorre = torreJugador1.getCasillero();
		...
		assertEquals(reyJugador1.getCasillero(), casilleroTorre);
